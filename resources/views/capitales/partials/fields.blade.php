...
<div class="form-group col-sm-6">
    ...
    {{ Form::select('capital_fijo_o_variable',['' => '-None-', 'Capital Fijo' => 'Capital Fijo', 'Capital Variable' => 'Capital Variable'],isset($capital->capital_fijo_o_variable) ? $capital->capital_fijo_o_variable : '', array('class' => 'form-control')) }}
</div>
...
<div class="form-group col-sm-6">
    ...
    <input type="number" class="form-control" placeholder="" name="capital_pagado" value="{{ $capital->capital_pagado or '' }}">

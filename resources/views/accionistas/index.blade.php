...
@section('myContent')
	...
	<a class="btn btn-success pull-right menu-cuentas" href="{{ url('composicionAccionaria', ['id' => $sociedad->id]) }}" role="button">Composición Accionaria</a>
	<a class="btn btn-success pull-right menu-cuentas" href="{{ url('listado_opciones', ['id' => $sociedad->id]) }}" role="button">Listado Opciones</a>
	<div class="row">
		<div class="col-md-12">

  ...
  <div class="form-group col-sm-12">
    ...
    <input type="date" class="form-control" id="" name="fecha_nombramiento" aria-describedby="emailHelp" placeholder="Fecha nombramiento" value="{{$poder->fecha_nombramiento or ''}}">
  ...
  <div class="form-group col-sm-6">
    <label>RUT</label>
    <input type="text" class="form-control" id="" name="rut" aria-describedby="emailHelp" placeholder="RUT" value="{{$poder->rut or ''}}">
  </div>
  ...
  <div class="form-group col-sm-6">
    ...
    {{ Form::select('forma_de_actuar',['' => '-None-', 'Unipersonal' => 'Unipersonal', 'Conjunta' => 'Conjunta'],isset($director->forma_de_actuar) ? $director->forma_de_actuar : '', array('class' => 'form-control')) }}
    <br>
  ...
  <div class="form-group col-sm-6">
    <label>Poder Inscrito en Registro de Comercio</label>
  ...
  <div class="form-group col-sm-12">
    <label>Instrumento Revocación de Poder</label>
  ...
  <div class="form-group col-sm-12">
    <label>Inscripción de Revocaciones en Registro de Comercio</label>

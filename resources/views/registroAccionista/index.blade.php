...
{!! Form::open([ 'route' => 'registro_accionistas.store', 'method' => 'POST', 'class' => 'update-registro-accionista-ajax','files' => true]) !!}
...
<script src="{{ asset('js/registro_accionistas.js') }}"></script>

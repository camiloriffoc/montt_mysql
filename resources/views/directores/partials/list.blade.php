    ...
    <tbody>
      @if($secretario)
        <tr style=" text-align: center;">
          ...
          <td><span class="glyphicon glyphicon-ok" aria-hidden="true"></span></td>
          <td><a href="/secretario/{{$secretario->directorio_id}}" class="menu-cuentas" style="margin-left: 5px;"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a> - <a href="/secretario/delete/{{$secretario->directorio_id}}" class="delete-secretario"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></a></td>
        </tr>
      @endif
    </tbody>
  </table>

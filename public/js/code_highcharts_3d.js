...
(function(C) {
    ...
    (function(c) {
        ...
        c.pointCameraDistance = function(c, y) {
            var p = y.options.chart.options3d,
                v = y.plotWidth / 2;
            y = y.plotHeight / 2;
    ...
    (function(c) {
        ...
        l.prototype.cuboid = function(b) {
            ...
            a.front = this.path(b[0]).attr({
                "class": "highcharts-3d-front"
            }).add(a);
            a.top = this.path(b[1]).attr({
                "class": "highcharts-3d-top"
            }).add(a);
            a.side = this.path(b[2]).attr({
            ...
            a.attr = function(a, b, d, g) {
                ...
                if (a.shapeArgs || z(a.x)) a = this.renderer.cuboidPath(a.shapeArgs || a), this.front.attr({
                    d: a[0]
                }), this.top.attr({
                    d: a[1]
                }), this.side.attr({
                ...
                else return m.prototype.attr.call(this, a, void 0, d, g);
                return this
            };
            a.animate = function(a, b, d) {
                z(a.x) && z(a.y) ? (a = this.renderer.cuboidPath(a),
                    this.front.animate({
                        d: a[0]
                    }, b, d), this.top.animate({
                        d: a[1]
                    }, b, d), this.side.animate({
                        d: a[2]
                    }, b, d), this.attr({
                        zIndex: -a[3]
                    })) : a.opacity ? (this.front.animate(a, b, d), this.top.animate(a, b, d), this.side.animate(a, b, d)) : m.prototype.animate.call(this, a, b, d);
                return this
            };
            a.destroy = function() {
                this.front.destroy();
        ...
        c.SVGRenderer.prototype.cuboidPath = function(a) {
            ...
            var g = a.x,
                ...
                t = a.depth,
                A = v[this.chartIndex],
                n, r, w = A.options.chart.options3d.alpha,
                h = 0,
                p = [{
                    x: g,
                    y: e,
        ...
        h(u.prototype, "drawChartBox", function(h) {
            if (this.is3d()) {
                var r = this.renderer,
                    ...
                    l = k + (b.right.visible ? b.right.size : 0),
                    n = d - (b.top.visible ? b.top.size : 0),
                    w = a + (b.bottom.visible ? b.bottom.size :
                        0),
                    t = 0 - (b.front.visible ? b.front.size : 0),
    ...
    (function(c) {
        ...
        k(p.prototype, "getPlotBandPath", function(b) {
            ...
            if (a && d)
                for (var e = 0; e < a.length; e += 6) c.push("M", a[e + 1], a[e +
    ...
    (function(c) {
        ...
        c.Series.prototype.translate3dPoints = function() {
            ...
            for (r = 0; r < this.data.length; r++) h = this.data[r], p && p.translate && (z = p.isLog && p.val2lin ? p.val2lin(h.z) : h.z, h.plotZ = p.translate(z), h.isInside = h.isInside ? z >= p.min && z <= p.max : !1), v.push({
                x: u(h.plotXold, h.plotX),
                y: u(h.plotYold, h.plotY),
    ...
    (function(c) {
        function q(c) {
            ...
            this.chart.is3d && this.chart.is3d() && (e.stroke = this.options.edgeColor || e.fill, e["stroke-width"] = y(this.options.edgeWidth, 1));
            return e
        }
        var u = c.each,
            p = c.perspective,
            ...
            u(c.data, function(a) {
                if (null !== a.y) {
                    ...
                    u([
                        ...
                        if (0 !== b[a[1]] && (b[a[0]] >= c[a[0] + "Axis"].len || b[a[0]] + b[a[1]] <= d))
        ...
        r(v.column.prototype, "plotGroup", function(c, e, b, f,
            k, d) {
            this.chart.is3d() && d && !this[e] && (this.chart.columnGroup || (this.chart.columnGroup = this.chart.renderer.g("columnGroup").add(d)), this[e] = this.chart.columnGroup, this.chart.columnGroup.attr(this.getPlotBox()), this[e].survive = !0);
        ...
        r(v.column.prototype, "pointAttribs", q);
        ...
        r(c.StackItem.prototype,
            "getStackBox",
            function(h, e) {
                var b = h.apply(this, [].slice.call(arguments, 1));
                if (e.is3d()) {
                    var f = {
                            x: b.x,
                            y: b.y,
    ...
    (function(c) {
        ...
        c(y.pie.prototype, "translate", function(c) {
            ...
            if (this.chart.is3d()) {
                var h = this,
                    ...
                    e = v.alpha,
                    b = v.beta,
                    f = p.stacking ? (p.stack || 0) * r : h._i * r,
                    f = f + r / 2;
                !1 !== p.grouping &&
                    (f = 0);
                u(h.data, function(c) {
        ...
        c(y.pie.prototype, "pointAttribs", function(c, h, q) {
            c = c.call(this, h, q);
            q = this.options;
            this.chart.is3d() && (c.stroke = q.edgeColor || h.color || this.color, c["stroke-width"] = p(q.edgeWidth, 1));
            return c
        });
            ...
            if (this.chart.is3d()) {
                ...
                u(this.data, function(c) {
                    var p = c.shapeArgs,
                        ...
                        e = (p.start + p.end) / 2,
                        b = c.labelPos,
                        f = -v * (1 - Math.cos((p.alpha ||
                            h.alpha) * q)) * Math.sin(e),
        ...
        c(y.pie.prototype, "animate", function(c) {
            if (this.chart.is3d()) {
                var h = arguments[1],
                    ...
                    q = this.group,
                    e = this.markerGroup;
                B && (!0 === p && (p = {}), h ? (q.oldtranslateX = q.translateX, q.oldtranslateY =
                    q.translateY, h = {
                        translateX: r[0],
                        translateY: r[1],
                        scaleX: .001,

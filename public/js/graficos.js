...
function graficaSegunCapital(id,$button){
    ...
    $.ajax({
            ...
            success: function(Result){
                ...
                var data = []
                $.each(Result['capital'], function(i,item){
                    var serie = new Array(item['Nombre o Razón social Accionistas'],parseInt(item['Porcentaje del Capital pagado']));
                    data.push(serie);
                });
                graficaCapital(data);
